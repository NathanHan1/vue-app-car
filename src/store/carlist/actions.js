async function load(commit,state){
    ...
    var {count,results} = await fetch(`http://hanzhibang.cn/car/cars?page=${page}&pagesize=${pagesize}&sortby=${sortby}&sortdirection=${sortdirection}${str}`).then(data=>data.json());
