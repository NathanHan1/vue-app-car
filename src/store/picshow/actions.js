export default {
    async init({ commit, state }) {
        ...
        var { info } = await fetch('http://hanzhibang.cn/car/cars/' + id).then(data => data.json());
        var carlike = await fetch('http://hanzhibang.cn/car/carlike/' + id).then(data => data.json());
        //拿到数据后，去改变state中的数据
    ...
    async changeShowPic({ commit, state }, { v }) {
        var { info } = await fetch('http://hanzhibang.cn/car/cars/' + v).then(data => data.json());
        var carlike = await fetch('http://hanzhibang.cn/car/carlike/' + v).then(data => data.json());
